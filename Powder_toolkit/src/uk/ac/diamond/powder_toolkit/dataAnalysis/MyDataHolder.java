...
public class MyDataHolder {
	 ...
	 * @param name string name of loadeddataobject
	 * @param flag the file ending useful in previous version
	 * @param data the list of Idatasets to be used
	 * @param filepath the filepath of the original file, this is unused when a cell in generated
	 */
	 ...
	 * @param name the name of the loaded data object
	 ...
	 * @param name the name of the loadeddataobject
	 * @param columnname the name of the IDataset
	 * @return IDataset
	 */
