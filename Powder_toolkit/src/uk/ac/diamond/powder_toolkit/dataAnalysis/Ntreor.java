...
public class Ntreor extends AbstractPowderIndexer implements IPowderIndexer{
	...
	// tool tips
	private static String[] tooltips = {"WAVE 1.5405981 WAVE LENGTH IN ANG. AS A RULE ONE SHOULD NEVER CHANGE WAVE FROM 1.5405981.","KH MAX H FOR CUBIC BASE LINE.","KK  MAX K FOR CUBIC BASE LINE.","KL MAX L FOR CUBIC BASE LINE.","KS MAX H+K+L FOR THIS LINE.","THH  MAX H FOR TETRAGONAL AND HEXAGONAL BASE LINES.",
			"THK MAX K FOR TETRAGONAL AND HEXAGONAL BASE LINES.","THL MAX L FOR TETRAGONAL AND HEXAGONAL BASE LINES.","THS MAX H+K+L FOR THESE LINES.","OH1 MAX H FOR THE FIRST ORTHORHOMBIC BASE LINE.",
			"OK1 MAX K FOR THE FIRST ORTHORHOMBIC BASE LINE.","OL1 MAX L FOR THE FIRST ORTHORHOMBIC BASE LINE.","OS1  MAX H+K+L FOR THIS LINE."," OH2  MAX H FOR THE SECOND ORTHORHOMBIC BASE LINE.",
			"OK2  MAX K FOR THE SECOND ORTHORHOMBIC BASE LINE.","OL2 MAX L FOR THE SECOND ORTHORHOMBIC BASE LINE.","OS2 MAX H+K+L FOR THIS LINE.","OH3  MAX H FOR THE THIRD ORTHORHOMBIC BASE LINE.",
			"OK3  MAX K FOR THE THIRD ORTHORHOMBIC BASE LINE.","OL3   MAX L FOR THE THIRD ORTHORHOMBIC BASE LINE.","OS3 MAX H+K+L FOR THIS LINE."," MH1 MAX ABS(H) FOR THE FIRST MONOCLINIC BASE LINE.",
			"MK1  MAX K FOR THE FIRST MONOCLINIC BASE LINE.","ML1 MAX L FOR THE FIRST MONOCLINIC BASE LINE."," MS1 MAX ABS(H)+K+L FOR THIS LINE.","MH2 MAX ABS(H) FOR THE SECOND MONOCLINIC BASE LINE.",
			"MK2 MAX K FOR THE SECOND MONOCLINIC BASE LINE.","ML2 MAX L FOR THE SECOND MONOCLINIC BASE LINE.","MS2 MAX ABS(H)+K+L FOR THIS LINE.","MH3 MAX ABS(H) FOR THE THIRD MONOCLINIC BASE LINE.",
			"MK3 MAX K FOR THE THIRD MONOCLINIC BASE LINE.","ML3 MAX L FOR THE THIRD MONOCLINIC BASE LINE.","MS3 MAX ABS(H)+K+L FOR THIS LINE.","MH4 MAX ABS(H) FOR THE FOURTH MONOCLINIC BASE LINE.",
			"MK4 MAX K FOR THE FOURTH MONOCLINIC BASE LINE.","ML4 MAX L FOR THE FOURTH MONOCLINIC BASE LINE.","MS4 MAX ABS(H)+K+L FOR THIS LINE.",
			...
			"LIST SEE. ABOVE.","IF 'SELECT' IS NON ZERO THE ORTHORHOMBIC BASE LINES ARE(SELECT,1,2) (SELECT,1,3) AND (SELECT,2,3)","MERIT FIGURE OF MERIT REQUIRED AS STOP LIMIT.",
			...
			"VOL MAX CELL VOLUME (IN ANGSTROEM**3)","CEM MAX CELL EDGE (IN ANGSTROEM)","D1 DEFINED AS FOR PROGRAM PIRUM. (WERNER P.E. ARKIV KEMI 31(1969)513-516)",
			"SSQTL DEFINED AS FOR PROGRAM PIRUM.","D2 DEFINED AS FOR PROGRAM PIRUM.",
			...
			"EDENS NOT USED UNLESS DENS EQ. NON ZERO.EDENS EQ. MAX. DEVIATION IN THE PARAMETER DENS.","MOLW NOT USED UNLESS DENS ( AND EDENS ) EQ. NON ZERO  MOL. WEIGHT IN A.U. (OBS CRYSTAL WATER INCLUDED)",
